...
<html lang="en">
  <head>
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="assets/painel/css/style.css" <!-- End layout styles -->
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="assets/painel/images/faces-clipart/pic-1.png" alt="image" />
                          </td>
                          <td> Herman Beck </td>
                          <td>
                            <div class="progress">
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="assets/painel/images/faces-clipart/pic-2.png" alt="image" />
                          </td>
                          <td> Messsy Adam </td>
                          <td>
                            <div class="progress">
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="assets/painel/images/faces-clipart/pic-3.png" alt="image" />
                          </td>
                          <td> John Richards </td>
                          <td>
                            <div class="progress">
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="assets/painel/images/faces-clipart/pic-4.png" alt="image" />
                          </td>
                          <td> Peter Meggik </td>
                          <td>
                            <div class="progress">
